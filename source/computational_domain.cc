...
void ComputationalDomain<dim>::declare_parameters (ParameterHandler &prm)
{
  ...
  {
    prm.declare_entry("Dirichlet boundary ids", "1,3,110", Patterns::List(Patterns::Integer(0)));
    prm.declare_entry("Neumann boundary ids", "0,2,110", Patterns::List(Patterns::Integer(0)));
